...
## The latest version
The latest version of this cartridge is 22.1.0.

This version includes improvements for create and update session errors, added Klarna Express Button in minicart, support for long running basket, rate-limits by operations.
