 ...
 * @param {Object} trialPeriod trial period
 * @param {Object} subscriptionPeriod subscription period
 * @param {Object} subscriptionFrequency subscription frequency
...
function getSubscriptionById( subscriptions, subId ) {
    var filteredSubscriptions = subscriptions.filter( function( sub ) {
        return sub.subscriptionId === subId;
    } );
    return filteredSubscriptions.length > 0 ? filteredSubscriptions[0] : null;
}
